...
class Header extends Component {
    ...
    if (isAnyRequiredFieldEmpty === false) {
      ...
      if (this.isValidContactNoForLogin(this.state.contactno)) {
        ...
        const headers = {
          ...
          authorization:
            "Basic " +
            window.btoa(this.state.contactno + ":" + this.state.password)
        };
        let uri =
          Config.endpointPrefix +
          Config.endpoints.find((endpoint) => endpoint.name === "Login").uri;
  ...
  onSignUpClick = () => {
    ...
    if (isAnyValidationFailed === false && isAnyRequiredFieldEmpty === false) {
      ...
      let uri =
        Config.endpointPrefix +
        Config.endpoints.find((endpoint) => endpoint.name === "Sign up").uri;
      fetch(uri, { method: "POST", headers, body: dataSignUp })
        .then(function (response) {
  ...
  isValidContactNo = (contactno) => {
    ...
    if (
      !isValidContactNo.test(contactno) &&
      !this.isContactNumberEmpty(contactno)
    ) {
  ...
  showNotification = (message) =>
    this.setState({ messageText: message, notificationOpen: true });
  closeNotification = () =>
    this.setState({ messageText: null, notificationOpen: false });
            ...
            <TabContainer>
              <div className="form-fields">
                <FormControl required>
                  ...
                  <FormHelperText className={this.state.loginContactInvalid}>
                ...
                <FormControl required>
                  ...
                  <br />
                  <FormHelperText className={this.state.loginErrorSpan}>
                    <span className="red">{this.state.loginError.message}</span>
                  </FormHelperText>
                </FormControl>
                <br />
              </div>
            ...
            <TabContainer>
              <div className="form-fields">
                ...
                <FormControl required>
                  ...
                  <FormHelperText className={this.state.signUpPasswordInvalid}>
                    <span className="red">
                ...
                <FormControl required>
                  ...
                  <FormHelperText className={this.state.signUpcontactInvalid}>
                    <span className="red">
                  ...
                  <br />
                  <FormHelperText className={this.state.signUpErrorSpan}>
                    <span className="red">
